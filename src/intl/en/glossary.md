...
# ERC-20
* == standard / MOST tokens | Ethereum network use -- for -- their creation
  * _Examples:_ stablecoins (DAI & USDC), exchange tokens (UNI from Uniswap)
* == ALTERNATIVE moneys | traditional systems
...
# Liquidity
* := how quickly & easily an asset can be -- converted into -- cash OR another asset
* decentralized exchanges have liquidity pools | 
  * asset holders can deposit their assets
  * traders can buy & sell assets -- via -- decentralized way
    * _Example:_ Uniswap 
...
* := collection of funds /
  ...
  * uses
    * facilitate trading | decentralized exchange (DEX)

# Liquidity tokens (LST)
* := digital tokens / 
  * issued to participants / deposit assets | liquidity pool
  * == participant's share -- of the -- pool
  * LATER, can be redeemed -- for -- initial deposit + trading fees' portion
    * trading fees' portion are -- generated by the -- pool's activity
    * == allow earning rewards
...
# Slasher
* slasher
  * == entity / scans attestations -- to -- search for slashable offenses

* Slashings
  * == broadcast -- to the -- network /
    * NEXT block proposer
      * adds the proof | block
      * receives a reward -- for -- slashing the malicious validator
...
* == node | [proof-of-stake](#proof-of-stake-pos) system /
  * responsible for
    ...
    * checking the work of OTHER validators
  * requirements
    * ⚠️stake 32 ETH⚠️
