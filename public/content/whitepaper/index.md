...
* Bitcoin
  * -- by --Satoshi Nakamoto
  * | 2009
  * FIRST digital asset / has NO
    * backing or "[intrinsic value](http://bitcoinmagazine.com/8640/an-exploration-of-intrinsic-value-what-it-is-why-bitcoin-doesnt-have-it-and-why-bitcoin-does-have-it/)"
    * centralized issuer or controllerHowever

* blockchain technology
  * == tool of distributed consensus
  * 👀ALTERNATIVE applications 👀
    * use on-blockchain digital assets -- to represent -- custom currencies & financial instruments 
      * _Example:_ [colored coins](https://docs.google.com/a/buterin.com/document/d/1AnkP_cVZTCMLIzw4DvsW6M8Q2JC0lIzrTLuoWu2z1BE/edit)
    * ownership of an underlying physical device
      * _Example:_ "[smart property](https://en.bitcoin.it/wiki/Smart_Property)"
    * non-fungible assets
      * _Example:_ domain names ("[Namecoin](http://namecoin.org)")
    * MORE complex applications / have digital assets -- directly controlled by a -- piece of code 
      * implementing arbitrary rules ("[smart contracts](http://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/idea.html)") or 
      * blockchain-based "[decentralized autonomous organizations](http://bitcoinmagazine.com/7050/bootstrapping-a-decentralized-autonomous-corporation-part-i/)" (DAOs)

* Ethereum
  * 's goal
    * blockchain / built-in FULLY FLEDGED Turing-complete programming language 
  * uses
    * create "contracts" -- to -- encode arbitrary state transition functions 
  * enable users to,
    * create ANY PREVIOUS systems
...
* decentralized digital currency
  * == ALTERNATIVE applications
  * EXIST around for decades, _Example:_ property registries 
* | 1980s and the 1990s,
  * anonymous e-cash protocols -- through -- Chaumian blinding (cryptographic primitive) /
    * currency -- with a -- high degree of privacy
    * failed to gain traction
      * Reason: 🧠reliance on a centralized intermediary🧠
* | 1998, 
  * Wei Dai's [b-money](http://www.weidai.com/bmoney.txt)
  * create money -- through --
    * solving computational puzzles
    * decentralized consensus / WITHOUT detailing the implementation
* | 2005,
  * Hal Finney introduced "[reusable proofs of work](https://nakamotoinstitute.org/finney/rpow/)",
    * b-money's ideas + Adam Back's computationally difficult Hashcash puzzles 
    * relying on trusted computing -- as a -- backend
* | 2009, 
  * by Satoshi Nakamoto
  * FIRST implementation of decentralized currency
  * == established primitives + "proof-of-work"
    * established primitives
      *  manage -- , through public key cryptography, -- ownership 
    * "proof-of-work"
      * == consensus algorithm / 
        * keep track of owner coins 
        * simple & moderate / network's nodes -- collectively agree on a -- set of canonical updates | Bitcoin ledger's state
        * enable free entry | consensus process
          * == solve the political problem of deciding who gets to influence the consensus
          * node's consensus voting process weight == node's computing power
* "proof-of-stake"
