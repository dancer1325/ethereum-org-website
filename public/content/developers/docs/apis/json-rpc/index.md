...
* goal
  * JSON-RPC API
    * used -- by -- Ethereum execution clients
  * RPC API
    * used -- by -- consensus clients 

## Client implementations {#client-implementations}

* Ethereum clients
  * | implement the JSON-RPC specification,
    * can utilize DIFFERENT programming languages 
    * see [individual client documentation](/developers/docs/nodes-and-clients/#execution-clients)

## Convenience Libraries {#convenience-libraries}

* 👀== wrappers | JSON-RPC API👀
* AVAILABLE ones
  * [JavaScript](/developers/docs/apis/javascript/#available-libraries)
  * [backend API](/developers/docs/apis/backend/#available-libraries) 
* steps
  * 1-line methods / initialize JSON-RPC requests 
* vs Ethereum clients / implement JSON-RPC API
  * use cases / easier
    * dapp developers
...
* == RPC API
  * allows users
    * query node's information
    * request Beacon blocks, Beacon state, and OTHER consensus-related information
...
* 'Engine API'
  * == internal API
  * uses
    * inter-client communication | node
      * == consensus client <-- can swap data with --> execution client
  * [specs](https://github.com/ethereum/execution-apis/blob/main/src/engine/common.md)

## Execution client spec {#spec}

* [spec](https://github.com/ethereum/execution-apis)
* [Execution API webpage](https://ethereum.github.io/execution-apis/api-documentation/)
* Inspector
  * try out ALL AVAILABLE methods
...
* E2E == compile a smart contract + deploy the smart contract
  * using
    * Geth node
    * JSON_RPC API
    * curl
